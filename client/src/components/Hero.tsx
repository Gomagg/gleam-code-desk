    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          {/* Tagline */}
          <p
            className="text-xl sm:text-2xl text-muted-foreground mb-8 animate-slide-up"
          ...
          >
            Transforming ideas into powerful web applications with 6+ years of
            programming experience and 3+ years of full-stack development
            expertise.
          </p>
          ...
          >
            <Button size="lg" variant="hero" asChild>
              <a
                href="https://www.upwork.com/freelancers/~01c792af1b3843b60e"
                target="_blank"
          ...
          {/* Social Links */}
          <div
            className="flex justify-center space-x-6 animate-slide-up"
            style={{ animationDelay: "0.8s" }}
          >
            <a
              href="https://github.com/Gomagg"
              target="_blank"
              rel="noopener noreferrer"
