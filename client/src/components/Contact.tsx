        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              something amazing. Let's discuss your project and create
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Prefer to reach out directly? I'm available through multiple
                  channels and always happy to discuss new opportunities.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4 p-4 bg-card border border-border rounded-lg hover:border-primary/50 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Available Mon-Fri, 9AM-6PM UTC+1
                    </p>
                  </div>
                </div>
              ...
              <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                ...
                <p className="text-sm text-green-600 dark:text-green-300">
                  Currently accepting new client projects for Q4 2024 and Q1
                  2025.
                </p>
              </div>
            </div>
